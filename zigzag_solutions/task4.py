...
class Pattern():
########################################################################################################################
    def __init__(self, SymbolToUse, PatternString, PatternCount=None):
...
########################################################################################################################
    def OutputPatternCount(self):
        if self.__PatternCount is not None:
            print(f"Pattern {self.__Symbol} has {self.__PatternCount} uses remaining")
            if not self.__PatternCount:
                print("    This symbol can be used, but will not match patterns.")
########################################################################################################################
