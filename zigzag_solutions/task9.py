...
########################################################################################################################
            ...
            for Double in available[:5]:
                self.__Grid[Double - 1] = DoublePointCell()
########################################################################################################################
            self.__AllowedPatterns = []
            self.__AllowedSymbols = []
                ...
                try:
                    ...
                    for P in self.__AllowedPatterns:
                        ...
                        if P.MatchesPattern(PatternString, CurrentSymbol):
                            for C in Cells:
                                C.AddToNotAllowedSymbols(CurrentSymbol)
                                if C.IsDouble() and not C.IsEmpty(False):
                                    DoublePoints = True
                            return 10 * (1 + DoublePoints)
########################################################################################################################
                except:
                    pass
        return 0
...
########################################################################################################################
    def IsEmpty(self, exclude_double=True):
        if len(self._Symbol) == 0 or (self._Symbol == "D" and not exclude_double):
            return True
        else:
            return False
########################################################################################################################
